...
import { deleteNote } from "@/app/actions/note/deleteNote.action";
...
const DeleteNote = ({ noteID }: IProps) => {
    ...
    const deleteNow = async () => {
        setLoading(true)
        await handleResponse(deleteNote(noteID))
        setLoading(false)
        handleCloseModal()
    }
    ...
    return <>
        ...
        >
            <div className="px-4 md:px-3">
                <p className="text-sm md:text-base">Are you sure you want to delete this Note ?</p>
