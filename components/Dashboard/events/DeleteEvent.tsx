...
import { deleteEvent } from "@/app/actions/event/deleteEvent.action";
...
const DeleteEvent = ({ eventID }: IProps) => {
    ...
    const deleteNow = async () => {
        setLoading(true)
        await handleResponse(deleteEvent(eventID))
        setLoading(false)
        handleCloseModal()
    }
    return <>
        ...
        >
            <div className="px-4 md:px-3">
                <p className="text-sm md:text-base">Are you sure you want to delete this Event ?</p>
