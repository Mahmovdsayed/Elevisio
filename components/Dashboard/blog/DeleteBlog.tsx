...
import { deleteBlog } from "@/app/actions/blog/deleteBlog.action";
...
const DeleteBlog = ({ blogID }: IProps) => {
    ...
    const deleteNow = async () => {
        setLoading(true)
        await handleResponse(deleteBlog(blogID))
        setLoading(false)
        handleCloseModal()
    }
    ...
    return <>
        ...
        >
            <div className="px-4 md:px-3">
                <p className="text-sm md:text-base">Are you sure you want to delete this Blog ?</p>
